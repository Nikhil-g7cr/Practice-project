...
import { getPhoneById } from "../../redux/features/phones/PhoneSlice";

const SmartphoneProduct = () => {
  // get the phones from the redux store
  const { id } = useParams();
  ...
  useEffect(() => {
    const hasPhoneForRoute =
      phones?.some((p) => p._id === id) || currentPhone?._id === id;

    if (id && !hasPhoneForRoute) {
      console.log("Phone not in store, fetching by ID:", id);
      dispatch(getPhoneById(id));
    }
  }, [id, phones, currentPhone, dispatch]);
          ...
          <div className="flex items-center justify-center min-h-screen">
            <div className="text-center">
              ...
              <p className="text-on-surface-variant font-semibold">
                Loading smartphone details...
              </p>
            </div>
          </div>
        )}

        {/* No Phone Found State */}
        {!loading && !phone && (
          <div className="flex items-center justify-center min-h-screen">
            <div className="text-center">
              <p className="text-on-surface font-bold text-2xl mb-4">
          ...
          <>
            <div className="grid grid-cols-1 mt-20 lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="relative group ">
                ...
                <div className="aspect-square rounded-4xl overflow-hidden bg-white flex items-center justify-center p-8">
                  <img
              ...
              >
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div>
                    ...
                    {phone?.storageVariants &&
                      phone.storageVariants.length > 0 && (
                  ...
                  <div className="flex items-center gap-4 pt-4">
                    ...
                    <button
                      ...
                      className={`flex-1 text-on-primary py-4 px-8 rounded-xl font-bold text-lg shadow-[0_4px_20px_rgba(46,50,48,0.06)] hover:scale-[1.02] active:scale-95 transition-all bg-linear-to-r ${isAdded ? "from-tertiary to-[#8c743c]" : "from-primary to-[#5b8c6a]"}`}
                    >
                      {cartStatus}
                    </button>
                  </div>
